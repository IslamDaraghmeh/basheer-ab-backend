...
insuredRouter.get('/filtered-list', auth(endPoints.allInsured), cacheMiddleware(300, paginationCacheKey), validateRequest(validation.filteredInsuredListQuerySchema, 'query'), insuredRoute.getFilteredInsuredList)
